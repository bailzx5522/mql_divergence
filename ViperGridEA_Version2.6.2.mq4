...
drawPriceLevels() 
{
   ...
   drawLevel( initialPrice, "Pivot",    StringToColor_(PivotColor) );
   drawLevel( sGoal    ,    "SellGoal", StringToColor_(SellColor) );
   drawLevel( bGoal     ,   "BuyGoal",  StringToColor_(BuyColor) );
...
//+------------------------------------------------------------------+
color
StringToColor_(string colorString) 
{
